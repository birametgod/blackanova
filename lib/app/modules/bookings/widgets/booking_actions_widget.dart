      ...
      return Container(
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.end, children: [
          ...
          if (_booking.value.status!.order == Get.find<GlobalService>().global.value.ready ||
              _booking.value.status!.order == Get.find<GlobalService>().global.value.inProgress)
            Expanded(
              child: Text(
          ...
          SizedBox(width: 5),
          if (_booking.value.payment != null &&
          ...
          if (!_booking.value.cancel! && _booking.value.status!.order < Get.find<GlobalService>().global.value.onTheWay!)
            MaterialButton(
              ...
              child: Text("Decline".tr, style: Get.textTheme.bodyMedium),
            ),
