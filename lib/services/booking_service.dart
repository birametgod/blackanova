...
import 'package:blackanova/models/availibility.dart';
import 'package:blackanova/models/booking.dart';
  ...
  Future<void> addAvailabilityDocument(String userId) async {
    try {
      Map<String, dynamic> availabilityData = {
        'availabilityMap': {
          '2024-03-07' : ['09:00 am','11:00 am','03:00 pm','05:00 pm','07:00 pm', '09:00 pm'],
          '2024-03-11': ['10:00 AM', '2:00 PM', '4:30 PM'],
          '2024-03-12': ['1:00 PM', '3:30 PM', '6:00 PM'],
        },
        'userId': userId,
      };
